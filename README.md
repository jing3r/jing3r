### Привет
Меня зовут Артём, я разработчик игр на Unity.
...
5. AI (в разработке):
Сейчас прототип тестируется как сражение двух игроков в режиме hot seat. Подробнее о планах на AI можно почитать в Readme проекта.
...
[Извержение вулкана (из рабочего проекта)](https://github.com/jing3r/VolcanoParticles)

Смоделировано с использованием системы частиц. Модель и текстуры вулкана - не мои.
